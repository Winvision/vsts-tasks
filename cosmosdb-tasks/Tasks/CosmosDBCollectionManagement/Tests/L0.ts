...
describe('Cosmos DB Collection Management L0 Suite', function () {
    this.timeout(parseInt(process.env.TASK_TEST_TIMEOUT) || 20000);

    it('Should fail when CosmosDBCollectionManagement is run with no working, tools or temp directory', (done) => {
